...
# --------------------------------------------------
#
# Builds the GWT/J2CL showcase with production settings
#
# --------------------------------------------------
...
msg "Build ${YELLOW}${LABEL}${NOFORMAT} showcase with production settings..."
mvn --projects org.patternfly:${ARTIFACT} --also-make -P showcase,prod clean package
