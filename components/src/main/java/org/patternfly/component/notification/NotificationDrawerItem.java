...
public class NotificationDrawerItem extends NotificationDrawerSubComponent<HTMLElement, NotificationDrawerItem> implements
    ...
    public static NotificationDrawerItem notificationDrawerItem() {
        return new NotificationDrawerItem(Id.unique(ComponentType.NotificationDrawer.id));
    }

    public static NotificationDrawerItem notificationDrawerItem(String identifier) {
        return new NotificationDrawerItem(identifier);
    }
    ...
    NotificationDrawerItem(String identifier) {
        super(SUB_COMPONENT_NAME, div().css(component(notificationDrawer, list, item)).element());
