...
public abstract class BaseComponentFlat<E extends HTMLElement, B extends TypedBuilder<E, B>> implements Component,
    ...
    protected BaseComponentFlat(ComponentType componentType, E element) {
    ...
    protected void storeFlatComponent() {
        ComponentStore.storeFlatComponent(this);
    }
