...
/** A popover body within a {@link Popover} component. */
public class PopoverBody extends PopoverSubComponent<HTMLDivElement, PopoverBody> implements
    ...
    public static final String SUB_COMPONENT_ID = "npb";
    public static final String SUB_COMPONENT_NAME = "PopoverBody";
