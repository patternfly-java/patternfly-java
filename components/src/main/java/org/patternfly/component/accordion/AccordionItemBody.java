...
public class AccordionItemBody extends AccordionSubComponent<HTMLDivElement, AccordionItemBody> implements
    ...
    public static AccordionItemBody accordionItemBody() {
        return new AccordionItemBody();
    }

    // ------------------------------------------------------ instance

    static final String SUB_COMPONENT_NAME = "acicb";
