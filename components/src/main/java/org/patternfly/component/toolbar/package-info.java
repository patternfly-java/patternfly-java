 ...
 *
 * <ul>
 *     <li>{@link org.patternfly.component.toolbar.AlignItems} - Enumeration of cross-axis alignment options for
 *     toolbar items</li>
 ...
 *     <li>{@link org.patternfly.component.toolbar.ToolbarColor} - Enumeration of toolbar color variants
 *     (no-background, primary, secondary)</li>
 ...
 *     <li>{@link org.patternfly.component.toolbar.ToolbarFilterLabelGroup} - Label group for displaying active
 *     filter labels</li>
 ...
 *     <li>{@link org.patternfly.component.toolbar.ToolbarItemType} - Typed item variants (bulk-select,
 *     overflow-menu, etc.)</li>
