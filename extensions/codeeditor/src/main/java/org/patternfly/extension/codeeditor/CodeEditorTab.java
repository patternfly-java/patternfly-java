...
import static org.patternfly.extension.codeeditor.CodeEditorTabIcon.codeEditorTabIcon;
import static org.patternfly.extension.codeeditor.CodeEditorTabText.codeEditorTabText;
...
public class CodeEditorTab extends CodeEditorSubComponent<HTMLDivElement, CodeEditorTab> {
    ...
    public static CodeEditorTab codeEditorTab(PredefinedIcon icon, String text) {
        return new CodeEditorTab()
                .addIcon(codeEditorTabIcon(icon.element()))
