 ...
 * </pre>
 *
 * <p>Instantiating a {@code SafeHtmlTemplates} interface with {@code GWT.create()} returns an
 ...
 * method parameter.
 *
 * <p>The code generator's template parser is lenient, and will accept HTML that is not well-formed;
 ...
 * </ol>
 *
 * <p><b>Limitation:</b> For templates with template variables in a CSS (style) context, the current
 * implementation of the code generator does not guarantee that the generated template method
 * produces values that adhere to the {@code SafeHtml} type contract. When the code generator
 * encounters a template with a variable in a style attribute or tag, such as, {@code <div
 * style=\"{0}\">}, a warning will be emitted. In this case, developers are advised to carefully
 * review uses of this template to ensure that parameters passed to the template are from a trusted
 * source or suitably sanitized.
 *
 * <p>Future implementations of the code generator may place additional constraints on template
 * parameters in style contexts.
 */
