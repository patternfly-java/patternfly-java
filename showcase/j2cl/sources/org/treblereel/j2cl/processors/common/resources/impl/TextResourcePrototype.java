...
public abstract class TextResourcePrototype implements TextResource {

  public boolean isInjected = false;

  public void insureInjectedAsScript() {
    if (!isInjected) {
      isInjected = true;
  ...
  public void insureInjectedAsStyle() {
    if (!isInjected) {
      isInjected = true;
      StyleInjector.fromString(getText()).inject();
    }
  }
}
