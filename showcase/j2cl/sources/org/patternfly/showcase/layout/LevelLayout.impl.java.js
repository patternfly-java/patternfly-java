...
class LevelLayout extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_layout_LevelLayout__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('level-basic', 'Basic', Code.m_code__java_lang_String__java_lang_String('level-basic'), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('level-gutter', 'With gutters', Code.m_code__java_lang_String__java_lang_String('level-gutter'), Supplier.$adapt(() =>{
