goog.module('org.patternfly.showcase.layout.Layout.$Overlay$impl');
...
class $Overlay {
 ...
 static m_implemented__$devirt__org_patternfly_showcase_layout_Layout__boolean(/** !Object */ $thisArg) {
  $Overlay.$clinit();
  return !$Equality.$same($thisArg.clazz, null) && !$Equality.$same($thisArg.route, null);
 }
 /** @final @nodts @return {SafeHtml} */
 static m_summary__$devirt__org_patternfly_showcase_layout_Layout__org_gwtproject_safehtml_shared_SafeHtml(/** !Object */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_apiDoc__$devirt__org_patternfly_showcase_layout_Layout__java_lang_String(/** !Object */ $thisArg) {
  $Overlay.$clinit();
 ...
 /** @final @nodts @return {?string} */
 static m_designGuidelines__$devirt__org_patternfly_showcase_layout_Layout__java_lang_String(/** !Object */ $thisArg) {
  $Overlay.$clinit();
  return 'https://www.patternfly.org/layouts/' + j_l_String.m_valueOf__java_lang_Object__java_lang_String($thisArg.name) + '/design-guidelines';
 }
 /** @nodts */
 static $clinit() {
  $Overlay.$clinit = () =>{};
...
//# sourceMappingURL=Layout$$Overlay.js.map
