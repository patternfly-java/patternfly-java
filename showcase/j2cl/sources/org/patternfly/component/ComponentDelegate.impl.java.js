...
let Ouia = goog.forwardDeclare('org.patternfly.component.Ouia$impl');
...
class ComponentDelegate extends j_l_Object {
 ...
 m_element__elemental2_dom_HTMLElement() {
  if ($Equality.$same(this.f_delegate__org_patternfly_component_ComponentDelegate_, null)) {
   Logger.m_undefined__java_lang_String__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType().f_componentName__org_patternfly_component_ComponentType, null, 'No delegate defined');
  }
 ...
 static $loadModules() {
  ...
  Ouia = goog.module.get('org.patternfly.component.Ouia$impl');
