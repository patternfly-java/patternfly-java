...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_DomGlobal_SetIntervalCallbackUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {?function(...*):void} */
 static m_asSetIntervalCallbackFn__$devirt__elemental2_dom_DomGlobal_SetIntervalCallbackUnionType__elemental2_dom_DomGlobal_SetIntervalCallbackFn(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {?function(...*):void}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), $JavaScriptFunction));
 }
 /** @nodts @return {?string} */
 static m_asString__$devirt__elemental2_dom_DomGlobal_SetIntervalCallbackUnionType__java_lang_String(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asString__java_lang_Object__java_lang_String($thisArg);
 }
 /** @nodts @return {TrustedScript} */
 static m_asTrustedScript__$devirt__elemental2_dom_DomGlobal_SetIntervalCallbackUnionType__elemental2_core_TrustedScript(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {TrustedScript}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), TrustedScript_$Overlay));
 }
 /** @nodts @return {boolean} */
 static m_isSetIntervalCallbackFn__$devirt__elemental2_dom_DomGlobal_SetIntervalCallbackUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return $JavaScriptFunction.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isString__$devirt__elemental2_dom_DomGlobal_SetIntervalCallbackUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return j_l_String.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isTrustedScript__$devirt__elemental2_dom_DomGlobal_SetIntervalCallbackUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
