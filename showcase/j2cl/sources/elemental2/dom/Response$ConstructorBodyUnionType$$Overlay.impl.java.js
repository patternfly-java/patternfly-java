...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_Response_ConstructorBodyUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {ArrayBuffer} */
 static m_asArrayBuffer__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__elemental2_core_ArrayBuffer(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asArrayBufferView__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__elemental2_core_ArrayBufferView(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ArrayBufferView}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), ArrayBufferView_$Overlay));
 }
 /** @nodts @return {Blob} */
 static m_asBlob__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__elemental2_dom_Blob(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {Blob}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), Blob_$Overlay));
 }
 /** @nodts @return {FormData} */
 static m_asFormData__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__elemental2_dom_FormData(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asReadableStream__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__elemental2_dom_ReadableStream(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ReadableStream}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), ReadableStream_$Overlay));
 }
 /** @nodts @return {?string} */
 static m_asString__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__java_lang_String(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asString__java_lang_Object__java_lang_String($thisArg);
 }
 /** @nodts @return {URLSearchParams} */
 static m_asURLSearchParams__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__elemental2_dom_URLSearchParams(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {URLSearchParams}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), URLSearchParams_$Overlay));
 }
 /** @nodts @return {boolean} */
 static m_isArrayBuffer__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ArrayBuffer_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isArrayBufferView__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ArrayBufferView_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isBlob__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Blob_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isFormData__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return FormData_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isReadableStream__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ReadableStream_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isString__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return j_l_String.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isURLSearchParams__$devirt__elemental2_dom_Response_ConstructorBodyUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
