goog.module('elemental2.dom.XMLHttpRequest.SendDataUnionType.$Overlay');
...
const $Overlay = goog.require('elemental2.dom.XMLHttpRequest.SendDataUnionType.$Overlay$impl');
/** @nodts */
exports = $Overlay;
