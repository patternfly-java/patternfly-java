...
public class RTCPeerConnection implements EventTarget {
  ...
  public native Promise<RTCSessionDescription> createOffer(
      JsObject successCallbackOrConstraintsOrOfferOptions,
      RTCPeerConnectionErrorCallback errorCallback,
      JsObject constraints);
  ...
  public final Promise<RTCSessionDescription> createOffer(
      Object successCallbackOrConstraintsOrOfferOptions,
      RTCPeerConnectionErrorCallback errorCallback,
      Object constraints) {
    return createOffer(
        Js.<JsObject>uncheckedCast(successCallbackOrConstraintsOrOfferOptions),
        errorCallback,
        Js.<JsObject>uncheckedCast(constraints));
  }
  ...
  public final Promise<RTCSessionDescription> createOffer(
      ...
      RTCPeerConnectionErrorCallback errorCallback) {
    return createOffer(
        Js.<JsObject>uncheckedCast(successCallbackOrConstraintsOrOfferOptions), errorCallback);
  }
