...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_ExtendableMessageEvent_SourceUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {MessagePort} */
 static m_asMessagePort__$devirt__elemental2_dom_ExtendableMessageEvent_SourceUnionType__elemental2_dom_MessagePort(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asServiceWorker__$devirt__elemental2_dom_ExtendableMessageEvent_SourceUnionType__elemental2_dom_ServiceWorker(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asServiceWorkerClient__$devirt__elemental2_dom_ExtendableMessageEvent_SourceUnionType__elemental2_dom_ServiceWorkerClient(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_isMessagePort__$devirt__elemental2_dom_ExtendableMessageEvent_SourceUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return MessagePort_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isServiceWorker__$devirt__elemental2_dom_ExtendableMessageEvent_SourceUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ServiceWorker_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isServiceWorkerClient__$devirt__elemental2_dom_ExtendableMessageEvent_SourceUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
