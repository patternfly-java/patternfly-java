...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_DomGlobal_OpenDatabaseCallbackUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {DatabaseCallback} */
 static m_asDatabaseCallback__$devirt__elemental2_dom_DomGlobal_OpenDatabaseCallbackUnionType__elemental2_dom_DatabaseCallback(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {DatabaseCallback}*/ (Js.m_cast__java_lang_Object__java_lang_Object($thisArg));
 }
 /** @nodts @return {?function(Database):*} */
 static m_asOpenDatabaseCallbackFn__$devirt__elemental2_dom_DomGlobal_OpenDatabaseCallbackUnionType__elemental2_dom_DomGlobal_OpenDatabaseCallbackFn(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {?function(Database):*}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), $JavaScriptFunction));
 }
 /** @nodts @return {boolean} */
 static m_isOpenDatabaseCallbackFn__$devirt__elemental2_dom_DomGlobal_OpenDatabaseCallbackUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
