...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_RTCStats_GetTimestampUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {number} */
 static m_asDouble__$devirt__elemental2_dom_RTCStats_GetTimestampUnionType__double(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asDouble__java_lang_Object__double($thisArg);
 }
 /** @nodts @return {Date} */
 static m_asJsDate__$devirt__elemental2_dom_RTCStats_GetTimestampUnionType__elemental2_core_JsDate(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {Date}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), JsDate_$Overlay));
 }
 /** @nodts @return {boolean} */
 static m_isDouble__$devirt__elemental2_dom_RTCStats_GetTimestampUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Double.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isJsDate__$devirt__elemental2_dom_RTCStats_GetTimestampUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
