...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_MessageEvent_InitMessageEventSourceArgUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {MessagePort} */
 static m_asMessagePort__$devirt__elemental2_dom_MessageEvent_InitMessageEventSourceArgUnionType__elemental2_dom_MessagePort(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asServiceWorker__$devirt__elemental2_dom_MessageEvent_InitMessageEventSourceArgUnionType__elemental2_dom_ServiceWorker(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ServiceWorker}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), ServiceWorker_$Overlay));
 }
 /** @nodts @return {Window} */
 static m_asWindow__$devirt__elemental2_dom_MessageEvent_InitMessageEventSourceArgUnionType__elemental2_dom_Window(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {Window}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), Window_$Overlay));
 }
 /** @nodts @return {boolean} */
 static m_isMessagePort__$devirt__elemental2_dom_MessageEvent_InitMessageEventSourceArgUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return MessagePort_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isServiceWorker__$devirt__elemental2_dom_MessageEvent_InitMessageEventSourceArgUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ServiceWorker_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isWindow__$devirt__elemental2_dom_MessageEvent_InitMessageEventSourceArgUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
