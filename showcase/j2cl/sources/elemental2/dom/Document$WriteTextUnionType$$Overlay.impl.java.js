...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_Document_WriteTextUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {?string} */
 static m_asString__$devirt__elemental2_dom_Document_WriteTextUnionType__java_lang_String(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asString__java_lang_Object__java_lang_String($thisArg);
 }
 /** @nodts @return {TrustedHTML} */
 static m_asTrustedHTML__$devirt__elemental2_dom_Document_WriteTextUnionType__elemental2_dom_TrustedHTML(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {TrustedHTML}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), TrustedHTML_$Overlay));
 }
 /** @nodts @return {boolean} */
 static m_isString__$devirt__elemental2_dom_Document_WriteTextUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return j_l_String.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isTrustedHTML__$devirt__elemental2_dom_Document_WriteTextUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
