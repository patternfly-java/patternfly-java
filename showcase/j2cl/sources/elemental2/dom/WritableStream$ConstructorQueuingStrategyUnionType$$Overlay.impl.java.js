...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_WritableStream_ConstructorQueuingStrategyUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {ByteLengthQueuingStrategy} */
 static m_asByteLengthQueuingStrategy__$devirt__elemental2_dom_WritableStream_ConstructorQueuingStrategyUnionType__elemental2_dom_ByteLengthQueuingStrategy(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asCountQueuingStrategy__$devirt__elemental2_dom_WritableStream_ConstructorQueuingStrategyUnionType__elemental2_dom_CountQueuingStrategy(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 /** @nodts @return {?} */
 static m_asTransformStreamWritableStrategyType__$devirt__elemental2_dom_WritableStream_ConstructorQueuingStrategyUnionType__elemental2_dom_TransformStream_TransformStreamWritableStrategyType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object($thisArg));
 }
 /** @nodts @return {boolean} */
 static m_isByteLengthQueuingStrategy__$devirt__elemental2_dom_WritableStream_ConstructorQueuingStrategyUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ByteLengthQueuingStrategy_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isCountQueuingStrategy__$devirt__elemental2_dom_WritableStream_ConstructorQueuingStrategyUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
