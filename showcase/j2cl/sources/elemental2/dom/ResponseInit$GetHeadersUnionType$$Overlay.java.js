goog.module('elemental2.dom.ResponseInit.GetHeadersUnionType.$Overlay');
...
const $Overlay = goog.require('elemental2.dom.ResponseInit.GetHeadersUnionType.$Overlay$impl');
/** @nodts */
exports = $Overlay;
