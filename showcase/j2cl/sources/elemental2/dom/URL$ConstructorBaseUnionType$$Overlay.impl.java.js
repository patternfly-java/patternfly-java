...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_URL_ConstructorBaseUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {?string} */
 static m_asString__$devirt__elemental2_dom_URL_ConstructorBaseUnionType__java_lang_String(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asString__java_lang_Object__java_lang_String($thisArg);
 }
 /** @nodts @return {URL} */
 static m_asURL__$devirt__elemental2_dom_URL_ConstructorBaseUnionType__elemental2_dom_URL(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {URL}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), URL_$Overlay));
 }
 /** @nodts @return {boolean} */
 static m_isString__$devirt__elemental2_dom_URL_ConstructorBaseUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return j_l_String.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isURL__$devirt__elemental2_dom_URL_ConstructorBaseUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
