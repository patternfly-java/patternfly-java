...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_FormData_GetUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {File} */
 static m_asFile__$devirt__elemental2_dom_FormData_GetUnionType__elemental2_dom_File(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {File}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), File_$Overlay));
 }
 /** @nodts @return {?string} */
 static m_asString__$devirt__elemental2_dom_FormData_GetUnionType__java_lang_String(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asString__java_lang_Object__java_lang_String($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isFile__$devirt__elemental2_dom_FormData_GetUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return File_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isString__$devirt__elemental2_dom_FormData_GetUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
