...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_BaseRenderingContext2D_FillStyleUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {CanvasGradient} */
 static m_asCanvasGradient__$devirt__elemental2_dom_BaseRenderingContext2D_FillStyleUnionType__elemental2_dom_CanvasGradient(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asCanvasPattern__$devirt__elemental2_dom_BaseRenderingContext2D_FillStyleUnionType__elemental2_dom_CanvasPattern(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {CanvasPattern}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), CanvasPattern_$Overlay));
 }
 /** @nodts @return {?string} */
 static m_asString__$devirt__elemental2_dom_BaseRenderingContext2D_FillStyleUnionType__java_lang_String(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asString__java_lang_Object__java_lang_String($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isCanvasGradient__$devirt__elemental2_dom_BaseRenderingContext2D_FillStyleUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return CanvasGradient_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isCanvasPattern__$devirt__elemental2_dom_BaseRenderingContext2D_FillStyleUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return CanvasPattern_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isString__$devirt__elemental2_dom_BaseRenderingContext2D_FillStyleUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
