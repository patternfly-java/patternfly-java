...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_dom_BaseRenderingContext2D_CreatePatternImageUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {HTMLCanvasElement} */
 static m_asHTMLCanvasElement__$devirt__elemental2_dom_BaseRenderingContext2D_CreatePatternImageUnionType__elemental2_dom_HTMLCanvasElement(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asHTMLImageElement__$devirt__elemental2_dom_BaseRenderingContext2D_CreatePatternImageUnionType__elemental2_dom_HTMLImageElement(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asHTMLVideoElement__$devirt__elemental2_dom_BaseRenderingContext2D_CreatePatternImageUnionType__elemental2_dom_HTMLVideoElement(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asImageBitmap__$devirt__elemental2_dom_BaseRenderingContext2D_CreatePatternImageUnionType__elemental2_dom_ImageBitmap(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ImageBitmap}*/ (Js.m_cast__java_lang_Object__java_lang_Object($thisArg));
 }
 /** @nodts @return {OffscreenCanvas} */
 static m_asOffscreenCanvas__$devirt__elemental2_dom_BaseRenderingContext2D_CreatePatternImageUnionType__elemental2_dom_OffscreenCanvas(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {OffscreenCanvas}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), OffscreenCanvas_$Overlay));
 }
 /** @nodts @return {boolean} */
 static m_isHTMLCanvasElement__$devirt__elemental2_dom_BaseRenderingContext2D_CreatePatternImageUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return HTMLCanvasElement_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isHTMLImageElement__$devirt__elemental2_dom_BaseRenderingContext2D_CreatePatternImageUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return HTMLImageElement_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isHTMLVideoElement__$devirt__elemental2_dom_BaseRenderingContext2D_CreatePatternImageUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return HTMLVideoElement_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isOffscreenCanvas__$devirt__elemental2_dom_BaseRenderingContext2D_CreatePatternImageUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
