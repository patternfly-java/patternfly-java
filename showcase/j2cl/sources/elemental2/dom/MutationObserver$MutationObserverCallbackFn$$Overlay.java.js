goog.module('elemental2.dom.MutationObserver.MutationObserverCallbackFn.$Overlay');
...
const $Overlay = goog.require('elemental2.dom.MutationObserver.MutationObserverCallbackFn.$Overlay$impl');
/** @nodts */
exports = $Overlay;
