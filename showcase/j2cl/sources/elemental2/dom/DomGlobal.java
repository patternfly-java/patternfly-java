...
public class DomGlobal {
  ...
  @JsOverlay
  public static final void postMessage(
      Object message, JsArray<Transferable> targetOriginOrOptionsOrTransfer) {
    postMessage(
        message,
        Js.<DomGlobal.PostMessageTargetOriginOrOptionsOrTransferUnionType>uncheckedCast(
            targetOriginOrOptionsOrTransfer));
  ...
  @JsOverlay
  public static final void postMessage(
      Object message, StructuredSerializeOptions targetOriginOrOptionsOrTransfer) {
    postMessage(
        message,
        Js.<DomGlobal.PostMessageTargetOriginOrOptionsOrTransferUnionType>uncheckedCast(
            targetOriginOrOptionsOrTransfer));
  ...
  @JsOverlay
  public static final void postMessage(
      Object message, Transferable[] targetOriginOrOptionsOrTransfer) {
