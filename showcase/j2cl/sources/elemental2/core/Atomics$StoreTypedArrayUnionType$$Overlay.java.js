goog.module('elemental2.core.Atomics.StoreTypedArrayUnionType.$Overlay');
...
const $Overlay = goog.require('elemental2.core.Atomics.StoreTypedArrayUnionType.$Overlay$impl');
/** @nodts */
exports = $Overlay;
