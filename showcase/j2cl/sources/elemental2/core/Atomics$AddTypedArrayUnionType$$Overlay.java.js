goog.module('elemental2.core.Atomics.AddTypedArrayUnionType.$Overlay');
...
const $Overlay = goog.require('elemental2.core.Atomics.AddTypedArrayUnionType.$Overlay$impl');
/** @nodts */
exports = $Overlay;
