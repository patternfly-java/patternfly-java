goog.module('elemental2.core.Atomics.CompareExchangeTypedArrayUnionType.$Overlay');
...
const $Overlay = goog.require('elemental2.core.Atomics.CompareExchangeTypedArrayUnionType.$Overlay$impl');
/** @nodts */
exports = $Overlay;
