goog.module('elemental2.core.Uint16Array.ConstructorLengthUnionType.$Overlay$impl');
...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_core_Uint16Array_ConstructorLengthUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {ArrayBuffer} */
 static m_asArrayBuffer__$devirt__elemental2_core_Uint16Array_ConstructorLengthUnionType__elemental2_core_ArrayBuffer(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asArrayBufferView__$devirt__elemental2_core_Uint16Array_ConstructorLengthUnionType__elemental2_core_ArrayBufferView(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ArrayBufferView}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), ArrayBufferView_$Overlay));
 }
 /** @nodts @return {number} */
 static m_asInt__$devirt__elemental2_core_Uint16Array_ConstructorLengthUnionType__int(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asInt__java_lang_Object__int($thisArg);
 }
 /** @nodts @return {Array<?number>} */
 static m_asJsArray__$devirt__elemental2_core_Uint16Array_ConstructorLengthUnionType__elemental2_core_JsArray(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asSharedArrayBuffer__$devirt__elemental2_core_Uint16Array_ConstructorLengthUnionType__elemental2_core_SharedArrayBuffer(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_isArrayBuffer__$devirt__elemental2_core_Uint16Array_ConstructorLengthUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ArrayBuffer_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isArrayBufferView__$devirt__elemental2_core_Uint16Array_ConstructorLengthUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ArrayBufferView_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isInt__$devirt__elemental2_core_Uint16Array_ConstructorLengthUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Double.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isJsArray__$devirt__elemental2_core_Uint16Array_ConstructorLengthUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return JsArray_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isSharedArrayBuffer__$devirt__elemental2_core_Uint16Array_ConstructorLengthUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
...
//# sourceMappingURL=Uint16Array$ConstructorLengthUnionType$$Overlay.js.map
