goog.module('elemental2.core.Atomics.XorTypedArrayUnionType.$Overlay');
...
const $Overlay = goog.require('elemental2.core.Atomics.XorTypedArrayUnionType.$Overlay$impl');
/** @nodts */
exports = $Overlay;
