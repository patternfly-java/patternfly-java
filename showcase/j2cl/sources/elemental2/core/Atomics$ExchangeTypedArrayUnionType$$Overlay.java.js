goog.module('elemental2.core.Atomics.ExchangeTypedArrayUnionType.$Overlay');
...
const $Overlay = goog.require('elemental2.core.Atomics.ExchangeTypedArrayUnionType.$Overlay$impl');
/** @nodts */
exports = $Overlay;
