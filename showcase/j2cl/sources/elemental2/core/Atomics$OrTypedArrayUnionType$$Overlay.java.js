goog.module('elemental2.core.Atomics.OrTypedArrayUnionType.$Overlay');
...
const $Overlay = goog.require('elemental2.core.Atomics.OrTypedArrayUnionType.$Overlay$impl');
/** @nodts */
exports = $Overlay;
