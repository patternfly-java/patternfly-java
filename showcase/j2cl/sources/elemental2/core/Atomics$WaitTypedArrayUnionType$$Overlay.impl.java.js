goog.module('elemental2.core.Atomics.WaitTypedArrayUnionType.$Overlay$impl');
...
class $Overlay {
 /** @nodts @return {?} */
 static m_of__java_lang_Object__elemental2_core_Atomics_WaitTypedArrayUnionType(/** * */ o) {
  $Overlay.$clinit();
  return /**@type {?}*/ (Js.m_cast__java_lang_Object__java_lang_Object(o));
 }
 /** @nodts @return {BigInt64Array} */
 static m_asBigInt64Array__$devirt__elemental2_core_Atomics_WaitTypedArrayUnionType__elemental2_core_BigInt64Array(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asInt32Array__$devirt__elemental2_core_Atomics_WaitTypedArrayUnionType__elemental2_core_Int32Array(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {Int32Array}*/ ($Casts.$to(Js.m_cast__java_lang_Object__java_lang_Object($thisArg), Int32Array_$Overlay));
 }
 /** @nodts @return {boolean} */
 static m_isBigInt64Array__$devirt__elemental2_core_Atomics_WaitTypedArrayUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return BigInt64Array_$Overlay.$isInstance($thisArg);
 }
 /** @nodts @return {boolean} */
 static m_isInt32Array__$devirt__elemental2_core_Atomics_WaitTypedArrayUnionType__boolean(/** ? */ $thisArg) {
  $Overlay.$clinit();
...
//# sourceMappingURL=Atomics$WaitTypedArrayUnionType$$Overlay.js.map
