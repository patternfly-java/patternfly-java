goog.module('elemental2.core.Atomics.AndTypedArrayUnionType.$Overlay');
...
const $Overlay = goog.require('elemental2.core.Atomics.AndTypedArrayUnionType.$Overlay$impl');
/** @nodts */
exports = $Overlay;
