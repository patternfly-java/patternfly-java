...
public class BuildingBlocks {
    ...
    public static Dropdown mixedKebab(String baseId) {
        return dropdown(ellipsisV(), "Column actions").applyToMenuList(list -> list
                ...
                .addItem(linkMenuItem(Id.build(baseId, "item-3"), "Disabled link", "#" + Id.build(baseId, "item-3")).disabled())
                .addDivider()
                .addItem(menuItem(Id.build(baseId, "item-4"), "Separated action"))
                .addItem(linkMenuItem(Id.build(baseId, "item-5"), "Separated link", "#" + Id.build(baseId, "item-5"))));
    }
}
