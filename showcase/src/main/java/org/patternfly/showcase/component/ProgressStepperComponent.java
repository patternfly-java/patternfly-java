...
import org.patternfly.component.progressstepper.ProgressStepVariant;
...
public class ProgressStepperComponent extends SnippetPage {
    ...
    public ProgressStepperComponent() {
        ...
        addApiDoc(ProgressStepVariant.class, other);
    }
}
