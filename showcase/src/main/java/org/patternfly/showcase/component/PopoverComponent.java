    ...
    public PopoverComponent() {
        ...
        addSnippet(new Snippet("popover-basic", "Basic",
                ...
                div().style("margin", "50px")
                        ...
                        .add(Popover.popover(By.id("popover-basic-button"))
        ...
        addSnippet(new Snippet("popover-hoverable", "Hoverable",
                ...
                div().style("margin", "50px")
                        ...
                        .add(Popover.popover(By.id("popover-hoverable-button"))
                                .hoverable()
        ...
        addSnippet(new Snippet("popover-placements", "Placements",
                ...
                div().style("display: flex; gap: 16px")
                        ...
                        .add(Popover.popover(By.id("nt-placements-bottom-button"))
                                .placement(bottom)
                        ...
                        .add(Popover.popover(By.id("nt-placements-left-button"))
                                .placement(left)
                        ...
                        .add(Popover.popover(By.id("nt-placements-right-button"))
                                .placement(right)
        ...
        addSnippet(new Snippet("popover-close", "Close popover",
            ...
            Popover popover = Popover.popover(By.id("popover-close-button"));
        ...
        addSnippet(new Snippet("popover-no-padding", "Without header/footer/close and no padding",
                ...
                div().style("margin", "50px")
                        ...
                        .add(Popover.popover(By.id("popover-no-padding-button"))
                                .noClose()
                                .noPadding()
        ...
        addSnippet(new Snippet("popover-auto-width", "Width auto",
                ...
                div().style("margin", "50px")
                        ...
                        .add(Popover.popover(By.id("popover-auto-width-button"))
                                .autoWidth()
        ...
        addSnippet(new Snippet("popover-auto-placement", "Auto placement",
            ...
            Popover popover = Popover.popover(By.id("popover-auto-placement-button"));
        ...
        addSnippet(new Snippet("popover-icon", "Popover with icon in the title",
                ...
                div().style("margin", "50px")
                        ...
                        .add(Popover.popover(By.id("popover-icon-button"))
                                .icon(bullhorn())
        ...
        addSnippet(new Snippet("popover-alert", "Alert popover",
            ...
            return div().style("margin", "50px")
                    ...
                    .add(Popover.popover(By.id("popover-alert-custom"))
                            .status(Severity.custom)
                            .addHeader("Popover custom header")
                            .addBody(LoremIpsum.words(20))
                            .addFooter("Popover footer"))
                    .add(Popover.popover(By.id("popover-alert-info"))
                            .status(Severity.info)
                            .addHeader("Popover info header")
                            .addBody(LoremIpsum.words(20))
                            .addFooter("Popover footer"))
                    .add(Popover.popover(By.id("popover-alert-success"))
                            .status(Severity.success)
                            .addHeader("Popover success header")
                            .addBody(LoremIpsum.words(20))
                            .addFooter("Popover footer"))
                    .add(Popover.popover(By.id("popover-alert-warning"))
                            .status(Severity.warning)
                            .addHeader("Popover warning header")
                            .addBody(LoremIpsum.words(20))
                            .addFooter("Popover footer"))
                    .add(Popover.popover(By.id("popover-alert-danger"))
