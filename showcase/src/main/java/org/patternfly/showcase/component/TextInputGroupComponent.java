...
import static org.patternfly.component.textinputgroup.TextInputGroup2.textInputGroup2;
...
public class TextInputGroupComponent extends SnippetPage {
    ...
    public TextInputGroupComponent() {
        ...
        addSnippet(new Snippet("tig-basic", "Basic",
                ...
                div()
                        .add(textInputGroup2("basic-tig-0"))
                        .element()
                // @code-end:tig-basic
        ));
        ...
        addSnippet(new Snippet("tig-disabled", "Disabled",
                ...
                div()
                        .add(textInputGroup2("disabled-tig-0", "Disabled")
                                .disabled())
                        .element()
        ...
        addSnippet(new Snippet("tig-utilities-and-icon", "Utilities and icon",
                ...
                div()
                        .add(textInputGroup2("utilities-tig-0")
                                .icon(search())
                                .clear())
                        .element()
        ...
        addSnippet(new Snippet("tig-validation", "With validation",
                ...
                div()
                        .add(flex().direction(column).rowGap(sm)
                                .addItem(flexItem()
                                        .add(textInputGroup2("validation-tig-0", "Success validation")
                                                .validated(success)))
                                .addItem(flexItem()
                                        .add(textInputGroup2("validation-tig-1",
                                                "Warning validation with custom non-status icon at start")
                                                .icon(search())
                                                .validated(warning)))
                                .addItem(flexItem()
                                        .add(textInputGroup2("validation-tig-2",
        ...
        addSnippet(new Snippet("tig-filters", "Filters",
                ...
                div()
                        .add(textInputGroup2("filters-tig-0")
