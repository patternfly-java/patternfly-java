...
public class CodeEditorHeader extends BaseSubComponent<HTMLDivElement, CodeEditorHeader> {
    ...
    CodeEditorHeader() {
        super(div().css(component(Classes.codeEditor, header)).element(), ComponentType.CodeEditor, SUB_COMPONENT_NAME);
    }
